...
CREATE TABLE matches (id SERIAL primary key,
                      ...
                      -- Add CHECK to ensure player_1 id is always less than
                      -- player_2 id, this will help ensure no rematches.
                      CHECK(player_1 < player_2));

CREATE UNIQUE INDEX no_rematches ON matches (player_1, player_2);
